...
;;Unit test for getStates helper funcction
(list "Tests for getStates helper function"
        ;; Using this to test for getStates method
        (list "test getStates 1" 1 'getStates '(1 ((1 1) (2 1) (3 1) (4 1) (5 3) (6 3) (7 3) (8 3)))
              '(exactly-equal 
...
(list "test getStates 2" 1 'getStates '(2 ((1 1) (2 1) (3 1) (4 1) (5 3) (6 3) (7 3) (8 3)))
              '(exactly-equal 
...
;;Unit test for getMoves helper funcction
(list "Tests for getMoves helper function"
        ;; Using this to test for getMoves method
        (list "test getMoves 2" 1 'getMoves '(2 ())
              '(exactly-equal 
...
;;Unit test for removeLoop helper funcction
(list "Tests for removeLoop helper function"
        ;; Using this to test for removeLoop method
        (list "test removeLoop 2" 1 'removeLoop '(2 2 ((("x" "x")("x" "X")("x" "y")("x" "Y")("x" "z")("x" "Z"))
	    (("X" "x")("X" "X")("X" "y")("X" "Y")("X" "z")("X" "Z"))
     	(("y" "x")("y" "X")("y" "y")("y" "Y")("y" "z")("y" "Z"))
   	  (("Y" "x")("Y" "X")("Y" "y")("Y" "Y")("Y" "z")("Y" "Z"))
     	(("z" "x")("z" "X")("z" "y")("z" "Y")("z" "z")("z" "Z"))
...
;;Unit test for helpFindState helper funcction
(list "Tests for helpFindState helper function"
        ;; Using this to test for helpFindState method
        (list "test helpFindState" 1 'helpFindState   '((
        ((1 1) (2 1) (3 1) (4 1) (5 3) (6 3) (7 3) (8 3))
...
;;Unit test for helpFindMove helper funcction
(list "Tests for helpFindMove helper function"
        ;; Using this to test for helpFindMove method
        (list "test helpFindMove" 1 'helpFindMove  '((
        ((1 1) (2 1) (3 1) (4 1) (5 3) (6 3) (7 3) (8 3))
        ((3 1) (1 1) (4 1) (2 1) (7 3) (5 3) (8 3) (6 3))
        ((4 1) (3 1) (2 1) (1 1) (8 3) (7 3) (6 3) (5 3))
        ((2 1) (4 1) (1 1) (3 1) (6 3) (8 3) (5 3) (7 3))
